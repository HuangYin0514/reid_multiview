...
def train(base, loaders, config):
    ...
    for i, data in enumerate(tqdm(loader)):
        ...
        if config.module == "B":
            ...
            quantified_localized_integrating_bn_features = base.auxiliaryModel(quantified_localized_integrating_bn_features)
            ...
            total_loss = ide_loss + quantified_localized_integrating_ide_loss + config.lambda1 * quantified_localized_integrating_reasoning_loss

...
class Model(nn.Module):
    ...
    def make_loss(self, loss_input_list, meter):
        ...
        for i in range(chunk_bs):
            ...
            print(sharedSpecialLoss, sharedSharedLoss, specialSpecialLoss)

        total_loss = ide_loss + integrating_ide_loss + 0.007 * integrating_reasoning_loss + 0.01 * decoupling_loss

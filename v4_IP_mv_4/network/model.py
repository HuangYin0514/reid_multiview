...
class Model(nn.Module):
    ...
    def make_loss(self, input_features, pids, meter):
        ...
        for i in range(chunk_bs):
            ...
            decoupling_loss += sharedSpecialLoss + 0.1 * sharedSharedLoss + 0.1 * specialSpecialLoss

        # 总损失
        total_loss = ide_loss + integrating_ide_loss + 0.007 * integrating_reasoning_loss + decoupling_loss + shared_ide_loss

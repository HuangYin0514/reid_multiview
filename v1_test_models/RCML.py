...
if __name__ == "__main__":
    ...
    input_1 = torch.randn((54, 2048))

    dims = [[2048, 2048, 2048], [2048, 2048, 2048], [2048, 2048, 2048], [2048, 2048, 2048]]
    model = RCML(4, dims, 702)
    evidences, evidence_a = model(input_1)
    # print(evidences)
    # print(evidences.shape)
    # print(evidence_a)
    print(evidence_a.shape)

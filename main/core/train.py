...
def train(base, loaders, config):
    ...
    for epoch, data in enumerate(tqdm(loader)):
        ...
        if config.module == "Lucky":
            ...
            #################################################################
            # Loss
            total_loss = ide_loss + integrating_ide_loss + 0.007 * reasoning_loss + decoupling_SharedSpecial_loss + 0.01 * decoupling_SharedShared_loss + 0.001 * decoupling_SpecificSpecific_loss

...
class MemoryBank(nn.Module):
    def __init__(self, num_features, num_classes, device="cpu", temperature=0.05, momentum=0.01):
        ...
        # 初始化样本记忆
        self.features_memory = torch.randn(num_classes, num_features, device=device)

...
# Runs
###########################################################
python main.py --task_name v356 --notes 定位/解耦/量化/融合 --tags dev resnet50 occluded_duke --mode train --output_path results/occluded_duke --occluded_duke_path /kaggle/input/occluded-duke/Occluded_Duke --pid_num 702 --module Lucky 

...
def train(base, loaders, config):
    ...
    for epoch, data in enumerate(tqdm(loader)):
        ...
        if config.module == "Lucky":
            ...
            # eps = 0.000005
            # total_loss = ide_loss / (ide_loss.detach() + eps) + localized_integrating_ide_loss / (localized_integrating_ide_loss.detach() + eps) + localized_integrating_reasoning_loss / (localized_integrating_reasoning_loss.detach() + eps)

...
def train(base, loaders, config):
    ...
    for epoch, data in enumerate(tqdm(loader)):
        ...
        if config.module == "Lucky":
            ...
            #################################################################
            # Loss
            total_loss = ide_loss + localized_integrating_ide_loss / (localized_integrating_ide_loss / ide_loss).detach() + 0.007 * localized_integrating_reasoning_loss / (localized_integrating_reasoning_loss / ide_loss).detach()
